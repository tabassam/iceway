...
@section('page_heading')
    Drive Types List
    <a href="/admin/driveTypes/create" class="btn btn-primary" style="float: right">Add Drive Type</a>
                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr class="gradeU">
                                ...
                                <td class="center">
                                    <a href="/admin/driveTypes/{{$type->id}}/edit" class="btn btn-primary btn-xs">Edit</a>
