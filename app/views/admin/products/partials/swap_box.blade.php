    ...
    <script type="text/javaScript">
        ...
        <div class="col-md-5">
            <label>Comment</label>
            {{ Form::select('comments', [],'1',['class' => 'form-control','id'=>'selectLeft','size'=>'10','style'=>'width:343px',isset($readonly)?'disabled':'']) }}
        </div>
        <div class="col-md-2">
            <label>Move</label>
            ...
            <div class="col-md-3">
                ...
                {{ Form::select('selectRight', $comment_keywords,'1',['class' => 'form-control','id'=>'selectRight','size'=>'10','style'=>'width:auto',isset($readonly)?'disabled':'']) }}
            </div>
